...
// Since we load Sortable via global script tag in index.html, it's available on window.
...
function setupResizeAndClickLogic() {
    ...
    container.addEventListener('pointermove', (e) => {
        ...
        const parentBg = activeItem.closest('.day-bg') as HTMLElement;
        if (parentBg) parentBg.style.gridRow = `2 / 50`;
    });
